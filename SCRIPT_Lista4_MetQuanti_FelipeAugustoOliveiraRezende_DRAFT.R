...
PDC_2013_genero <- PDC_2013 %>%
  filter(`Paridade Gênero` == 1)
nrow(PDC_2013)
nrow(PDC_2013_genero)
prop.test(73, 243)

PDC_2013_raça <- PDC_2013 %>%
  filter(`Paridade Raça` == 1)
nrow(PDC_2013)
nrow(PDC_2013_raça)
prop.test(54, 243)

PDC_2013_gen_raça <- PDC_2013 %>%
  filter(`Paridade Gênero` == 1, `Paridade Raça` == 1)
nrow(PDC_2013)
nrow(PDC_2013_gen_raça)
prop.test(28, 243)
